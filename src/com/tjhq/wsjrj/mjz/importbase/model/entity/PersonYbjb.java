...
/**
 * 
 * @TableName fm_hrmdata_ybjb
 */
@TableName(value ="fm_hrmdata_ybjb")
public class PersonYbjb extends BaseEntity implements Serializable {
    /**
     * 主键ID
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        PersonYbjb other = (PersonYbjb) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getSfzzcb() == null ? other.getSfzzcb() == null : this.getSfzzcb().equals(other.getSfzzcb()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSfzzcb() == null) ? 0 : getSfzzcb().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", sfzzcb=").append(sfzzcb);
