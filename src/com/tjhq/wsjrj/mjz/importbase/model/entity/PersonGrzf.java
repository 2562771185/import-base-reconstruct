...
/**
 * 
 * @TableName fm_hrmdata_ybjc
 */
@TableName(value ="fm_hrmdata_ybjc")
public class PersonGrzf extends BaseEntity implements Serializable {
    /**
     * 主键ID
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        PersonGrzf other = (PersonGrzf) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getGrzfje() == null ? other.getGrzfje() == null : this.getGrzfje().equals(other.getGrzfje()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getGrzfje() == null) ? 0 : getGrzfje().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", grzfje=").append(grzfje);
