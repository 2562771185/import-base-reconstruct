...
/**
 * 
 * @TableName fm_hrmdata_glbz
 */
@TableName(value ="fm_hrmdata_glbz")
public class PersonGlbz extends BaseEntity implements Serializable {
    /**
     * 主键ID
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        PersonGlbz other = (PersonGlbz) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getGlbzlx() == null ? other.getGlbzlx() == null : this.getGlbzlx().equals(other.getGlbzlx()))
            ...
            && (this.getJiaoyan() == null ? other.getJiaoyan() == null : this.getJiaoyan().equals(other.getJiaoyan()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getGlbzlx() == null) ? 0 : getGlbzlx().hashCode());
        ...
        result = prime * result + ((getJiaoyan() == null) ? 0 : getJiaoyan().hashCode());
        return result;
    }
