...
/**
 * 
 * @TableName fm_hrmdata_swxx
 */
@TableName(value ="fm_hrmdata_swxx")
public class PersonSwxx extends BaseEntity implements Serializable {
    /**
     * 主键ID
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        PersonSwxx other = (PersonSwxx) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getSwsj() == null ? other.getSwsj() == null : this.getSwsj().equals(other.getSwsj()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getSwsj() == null) ? 0 : getSwsj().hashCode());
