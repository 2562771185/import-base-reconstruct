...
/**
 * 
 * @TableName fm_hrmdata_cjra
 */
@TableName(value ="fm_hrmdata_cjra")
public class PersonCjra extends BaseEntity implements Serializable {
    /**
     * 主键ID
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        PersonCjra other = (PersonCjra) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getCjrbzlxa() == null ? other.getCjrbzlxa() == null : this.getCjrbzlxa().equals(other.getCjrbzlxa()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCjrbzlxa() == null) ? 0 : getCjrbzlxa().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", cjrbzlxa=").append(cjrbzlxa);
