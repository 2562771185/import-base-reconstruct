...
/**
 * 
 * @TableName fm_hrmdata_etbz
 */
@TableName(value ="fm_hrmdata_etbz")
public class PersonEtbz extends BaseEntity implements Serializable {
    /**
     * 主键ID
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        PersonEtbz other = (PersonEtbz) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getEtbzlx() == null ? other.getEtbzlx() == null : this.getEtbzlx().equals(other.getEtbzlx()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getEtbzlx() == null) ? 0 : getEtbzlx().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", etbzlx=").append(etbzlx);
