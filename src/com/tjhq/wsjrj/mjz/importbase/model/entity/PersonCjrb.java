...
/**
 * 
 * @TableName fm_hrmdata_cjrb
 */
@TableName(value ="fm_hrmdata_cjrb")
public class PersonCjrb extends BaseEntity implements Serializable {
    /**
     * 主键ID
     */
    @TableId
     ...
     * 残疾人保障类型2
     */
    public void setCjrbzlxb(String cjrbzlxb) {
    ...
    public boolean equals(Object that) {
        ...
        PersonCjrb other = (PersonCjrb) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getCjrbzlxb() == null ? other.getCjrbzlxb() == null : this.getCjrbzlxb().equals(other.getCjrbzlxb()));
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCjrbzlxb() == null) ? 0 : getCjrbzlxb().hashCode());
        return result;
    }
    ...
    public String toString() {
        ...
        sb.append(", cjrbzlxb=").append(cjrbzlxb);
