...
public class GrzfImportExcelService extends AbstractImport {
    ...
    protected void printLog(StringBuilder logStr) {
        FileUtil.printLog(logStr, SysConstant.LogPath.GRZF_LOG_FILEPATH);
    }
    ...
    protected String buildSqlString(BaseEntity entity) {
        ...
        PersonGrzf dbData = (PersonGrzf) entity;
        StringBuilder sql = new StringBuilder();
        sql.append("INSERT INTO FM_HRMDATA_YBJC (ID,SZNF,SZYF,XM,SFZH,GRZFJE,STATUS,VERSION,CREATE_TIME,UPDATE_TIME,CREATE_USER_ID,CREATE_ORG_ID) VALUES ");
        ...
        sql.append("('").append(uuid).append("','")
                ...
                .append(dbData.getGrzfje()).append("','")
                .append("1").append("',")
                .append(1).append(",'")
